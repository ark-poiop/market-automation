...
def main():
    ...
    try:
        ...
        # 샘플 데이터 준비 (실제 운영 시에는 API에서 미국 개장 전 데이터 수집)
        sample_data = {
            "date": "2025-08-13",
        ...
        # 포스팅 실행
        print("\n🔄 미국 개장 전 포스팅 실행 중...")
        result = poster.post_us_preview(sample_data)
        
        if result["success"]:
            print("✅ 미국 개장 전 포스팅 성공")
            ...
            print(f"❌ 미국 개장 전 포스팅 실패: {result.get('error', 'Unknown error')}")
